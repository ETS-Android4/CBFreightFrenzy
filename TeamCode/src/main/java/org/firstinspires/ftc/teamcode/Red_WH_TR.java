    ...
    public void runOpMode() {
        ...
        if (!opModeIsActive()) ;
        {
            ...
            if (rightPos > 500) { //level 3
                ...
                encoderDrive(22, 0.8, "strafe");
                fullTurn("counterclockwise");


                encoderIARM(14,0.6);
                robot.INTAKESERVO.setPower(1);
                encoderDrive(-11, 0.8, "strafe");
                ...
                encoderDrive(-23, 0.7, "drive");
                encoderDrive(-17, 0.8, "strafe");
                encoderDrive(-50, 0.7, "drive");
